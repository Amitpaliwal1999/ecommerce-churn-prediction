...
Project Workflow
Imported dataset into MySQL Workbench for initial querying and aggregation
Loaded and cleaned data in Google Colab (handled missing values, removed duplicates)
Performed exploratory data analysis using Pandas and visualization libraries
Engineered features such as RFM scores, engagement score, and risk flags
Trained and compared Random Forest, Gradient Boosting, and XGBoost models
Selected XGBoost as the final model based on ROC-AUC and false negative rate
Exported churn scores and processed data
